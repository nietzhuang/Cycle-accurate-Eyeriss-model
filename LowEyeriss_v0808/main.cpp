...
SC_MODULE(SYSTEM) {
	sc_clock						clk;
	sc_signal<    bool	  >			rst;
	sc_signal< sc_uint<16>>			addr_w_in;
	sc_signal< sc_int<8>  >			w_rdata;
	sc_signal< sc_uint<16>>			addr_ifmpa_in;
	...
	SC_CTOR(SYSTEM) : clk("clk", 10, SC_NS) {
		...
		//
		sc_trace(tracefile, low_eyeriss_i->scheduler_i->pass_tmp, "low_eyeriss_i.scheduler_i.pass_tmp");
		//
		...
		sc_trace(tracefile, low_eyeriss_i->scheduler_i->weight_out_PE[5][0], "low_eyeriss_i.scheduler_i.weight_out_PE[5][0]");
		sc_trace(tracefile, low_eyeriss_i->scheduler_i->weight_out_PE[5][1], "low_eyeriss_i.scheduler_i.weight_out_PE[5][1]");
		sc_trace(tracefile, low_eyeriss_i->scheduler_i->weight_out_PE[5][2], "low_eyeriss_i.scheduler_i.weight_out_PE[5][2]");
		sc_trace(tracefile, low_eyeriss_i->scheduler_i->weight_out_PE[5][3], "low_eyeriss_i.scheduler_i.weight_out_PE[5][3]");
		sc_trace(tracefile, low_eyeriss_i->scheduler_i->weight_out_PE[6][0], "low_eyeriss_i.scheduler_i.weight_out_PE[6][0]");
		sc_trace(tracefile, low_eyeriss_i->scheduler_i->weight_out_PE[7][0], "low_eyeriss_i.scheduler_i.weight_out_PE[7][0]");
		...
		//
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_0_0->enable, "low_eyeriss_i.pe_array_i.PE_0_0.enable");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_0_0->in_vld, "low_eyeriss_i.pe_array_i.PE_0_0.in_vld");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_0_0->out_vld, "low_eyeriss_i.pe_array_i.PE_0_0.out_vld");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_0_0->w_in, "low_eyeriss_i.pe_array_i.PE_0_0.w_in");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_0_0->ifmap_in, "low_eyeriss_i.pe_array_i.PE_0_0.ifmap_in");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_0_0->ofmap_out, "low_eyeriss_i.pe_array_i.PE_0_0.ofmap_out");
		...
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_3_0->enable, "low_eyeriss_i.pe_array_i.PE_3_0.enable");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_3_0->in_vld, "low_eyeriss_i.pe_array_i.PE_3_0.in_vld");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_3_0->out_vld, "low_eyeriss_i.pe_array_i.PE_3_0.out_vld");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_3_0->w_in, "low_eyeriss_i.pe_array_i.PE_3_0.w_in");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_3_0->ifmap_in, "low_eyeriss_i.pe_array_i.PE_3_0.ifmap_in");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_3_0->ofmap_out, "low_eyeriss_i.pe_array_i.PE_3_0.ofmap_out");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_4_0->enable, "low_eyeriss_i.pe_array_i.PE_4_0.enable");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_4_0->in_vld, "low_eyeriss_i.pe_array_i.PE_4_0.in_vld");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_4_0->out_vld, "low_eyeriss_i.pe_array_i.PE_4_0.out_vld");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_4_0->w_in, "low_eyeriss_i.pe_array_i.PE_4_0.w_in");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_4_0->ifmap_in, "low_eyeriss_i.pe_array_i.PE_4_0.ifmap_in");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_4_0->ofmap_out, "low_eyeriss_i.pe_array_i.PE_4_0.ofmap_out");
		//
