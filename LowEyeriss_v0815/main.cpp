...
SC_MODULE(SYSTEM) {
	...
	SC_CTOR(SYSTEM) : clk("clk", 10, SC_NS) {
		...
		//
		sc_trace(tracefile, low_eyeriss_i->glb_i->ofmap_buf[0][0], "low_eyeriss_i.glb_i.ofmap_buf[0][0]");
		sc_trace(tracefile, low_eyeriss_i->glb_i->psum_test_buf[0][0][0], "low_eyeriss_i.glb_i.psum_test_buf[0][0][0]");
		//
		...
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_0_13->enable, "low_eyeriss_i.pe_array_i.PE_0_13.enable");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_0_13->in_vld, "low_eyeriss_i.pe_array_i.PE_0_13.in_vld");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_0_13->out_vld, "low_eyeriss_i.pe_array_i.PE_0_13.out_vld");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_0_13->w_in, "low_eyeriss_i.pe_array_i.PE_0_13.w_in");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_0_13->ifmap_in, "low_eyeriss_i.pe_array_i.PE_0_13.ifmap_in");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_0_13->ofmap_out, "low_eyeriss_i.pe_array_i.PE_0_13.ofmap_out");
		//
