...
SC_MODULE(GLB) {
	...
	sc_signal< sc_int<8> >	filter[filter_height*num_filter][filter_width][num_channel];
	sc_signal< sc_int<8> >	ifmap[ifmap_height][ifmap_width][num_channel];
	sc_signal<sc_uint<12>>	ofmap_buf[ofmap_height][ofmap_width][num_filter];
	sc_signal<sc_uint<12>>	psum_test_buf[ofmap_height*num_filter][ofmap_width][num_channel];
