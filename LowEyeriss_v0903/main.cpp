...
SC_MODULE(SYSTEM) {
	...
	SC_CTOR(SYSTEM) : clk("clk", 10, SC_NS) {
		...
		low_eyeriss_i->cpu_trigger(cpu_trigger);
		low_eyeriss_i->conf_bits(conf_bits);
		low_eyeriss_i->conf_done(conf_done);
		...
		sc_trace(tracefile, low_eyeriss_i->config_i->cpu_trigger, "low_eyeriss_i.config_i.cpu_trigger");
		sc_trace(tracefile, low_eyeriss_i->config_i->conf_bits, "low_eyeriss_i.config_i.conf_bits");
		sc_trace(tracefile, low_eyeriss_i->config_i->conf_done, "low_eyeriss_i.config_i.conf_done");
		sc_trace(tracefile, low_eyeriss_i->config_i->filter_height_cf, "low_eyeriss_i.config_i.filter_height_cf");
		sc_trace(tracefile, low_eyeriss_i->config_i->filter_width_cf, "low_eyeriss_i.config_i.filter_width_cf");

		// Test trace
		sc_trace(tracefile, low_eyeriss_i->scheduler_i->count_pass, "low_eyeriss_i.scheduler_i.count_pass");
		//
		sc_trace(tracefile, low_eyeriss_i->glb_i->w_done, "low_eyeriss_i.glb_i.w_done");
		...
		sc_trace(tracefile, low_eyeriss_i->glb_i->filter_done, "low_eyeriss_i.glb_i.filter_done");
		...
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_0_2->in_vld, "low_eyeriss_i.pe_array_i.PE_0_2.in_vld");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_0_2->out_vld, "low_eyeriss_i.pe_array_i.PE_0_2.out_vld");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_0_2->w_in, "low_eyeriss_i.pe_array_i.PE_0_2.w_in");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_0_2->ifmap_in, "low_eyeriss_i.pe_array_i.PE_0_2.ifmap_in");
		sc_trace(tracefile, low_eyeriss_i->pe_array_i->PE_0_2->ofmap_out, "low_eyeriss_i.pe_array_i.PE_0_2.ofmap_out");
